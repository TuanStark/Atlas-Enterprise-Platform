...
export class Contract extends AggregateRoot<ContractProps> {
  ...
  get employmentId() { return this.props.employmentId; }
  get contractTypeId() { return this.props.contractTypeId; }
  ...
  get signedDate() { return this.props.signedDate; }
  get fileId() { return this.props.fileId; }
  get isCurrent() { return this.props.isCurrent; }
  get status() { return this.props.status; }
  get baseSalary() { return this.props.baseSalary; }
  get workingHours() { return this.props.workingHours; }
  get contractTemplateId() { return this.props.contractTemplateId; }
  get createdAt() { return this.props.createdAt; }
  get updatedAt() { return this.props.updatedAt; }
  get annexes(): readonly ContractAnnex[] { return this.props.annexes; }

  // Domain Logic

  sign(signedDate: Date, fileId?: string) {
    if (this.props.status !== ContractStatus.draft && this.props.status !== ContractStatus.pending_signature) {
  ...
  terminate() {
    if (this.props.status === ContractStatus.terminated || this.props.status === ContractStatus.expired) {
      return;
    }
  ...
  addAnnex(props: Omit<ContractAnnexProps, 'employmentContractId' | 'createdAt' | 'updatedAt'>): ContractAnnex {
