...
import { CreateCustomFieldDefinitionHandler, DeleteCustomFieldDefinitionHandler, SaveCustomFieldValuesHandler } from './application/commands/custom-field.commands';
import { ListCustomFieldDefinitionsHandler, GetCustomFieldValuesHandler } from './application/queries/custom-field.queries';
...
const CommandHandlers = [CreateCustomFieldDefinitionHandler, DeleteCustomFieldDefinitionHandler, SaveCustomFieldValuesHandler];
