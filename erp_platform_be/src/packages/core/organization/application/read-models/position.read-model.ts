...
export class PositionReadModel {
  @ApiProperty({ description: 'Unique identifier of the position', example: '79c97e1e-972f-466f-a71a-f729d3a8feac' })
  id!: string;

  @ApiProperty({ description: 'ID of the organization organizationId', example: '99531e55-d109-47e9-b23e-c54c556cb5e7' })
